                            ...
                            <Form autoComplete='off'>
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    <Box sx={{ display: 'flex', alignItems: 'flex-end' }}>
                                        ...
                                        <TextField id="input-with-sx" label="Email or Username" variant="standard" className='w-100' />
                                    </Box>
                                </Form.Group>
                                <Form.Group className="mb-3" controlId="formBasicPassword">
                                <Box sx={{ display: 'flex', alignItems: 'flex-end' }}>
                                    <PasswordIcon sx={{ color: 'action.active', mr: 1, my: 0.5 }} />
                                    <TextField type="password" id="input-with-sx" label="Password" variant="standard" className='w-100' />
                                </Box>
                                </Form.Group>
                                ...
                                <Link to='/home'>
                                    <Button variant="outlined" className='w-100 py-2'>LogIn</Button>
                                </Link>
                            </Form>
                        </div>
